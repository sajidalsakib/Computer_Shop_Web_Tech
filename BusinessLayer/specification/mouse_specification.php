<?php
    ...
    $interface = $singleProduct->interface;
    $mouse_number_of_keys = $singleProduct->mouse_number_of_keys;
...
<body>
    ...
    <table class="table" cellpadding="7" cellspacing="0" >
        ...
        <tr>
            <td class="name">Mouse_number_of_keys</td>
            <td><?php echo $mouse_number_of_keys ?></td>
        </tr>
        <tr style="background-color:rgba(192, 192, 192, 0.568);">
