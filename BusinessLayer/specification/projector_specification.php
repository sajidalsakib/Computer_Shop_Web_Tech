<?php
    ...
    $lumnes = $singleProduct->lumnes;
    $display_technology = $singleProduct->display_technology;
    $contrast_ratio = $singleProduct->contrast_ratio;
...
<body>
    ...
    <table class="table" cellpadding="7" cellspacing="0" >
        ...
        <tr style="background-color:rgba(192, 192, 192, 0.568);">
            <td class="name">Lumnes</td>
            <td><?php echo $lumnes ?></td>
        </tr>
        <tr>
            <td class="name">Contrast Ratio</td>
            <td><?php echo $contrast_ratio ?></td>
        </tr>
        <tr style="background-color:rgba(192, 192, 192, 0.568);">
            <td class="name">Display Technology</td>
            <td><?php echo $display_technology ?></td>
        </tr>
        <!-- <tr>
