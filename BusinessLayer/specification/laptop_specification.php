<?php
    ...
    $screen = $singleProduct->screenSize." ".$singleProduct->screenResulation;

    $ram = $singleProduct->ramBusSpeed." ".$singleProduct->ramCapacity." ".$singleProduct->ramType;

    $graphicsCard = $singleProduct->graphicsCardType." ".$singleProduct->graphicsCardCapacity." ".$singleProduct->graphicsCardMemoryType;

    $storage = $singleProduct->hddCapacity." ".$singleProduct->hddSpeed." ".$singleProduct->hddFormFactor." ".$singleProduct->ssdCapacity." ".$singleProduct->ssdFormFactor;
