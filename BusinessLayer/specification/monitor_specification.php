<?php
    ...
    $refreshRate = $singleProduct->refreshRate;
    $model = $singleProduct->model;
    $inputType = $singleProduct->inputType;
    $resulation = $singleProduct->resulation;
...
<body>
    ...
    <table class="table" cellpadding="7" cellspacing="0" >
        ...
        <tr style="background-color:rgba(192, 192, 192, 0.568);">
            <td class="capacity">Refresh Rate</td>
        ...
        <tr style="background-color:rgba(192, 192, 192, 0.568);">
            <td class="capacity">Resulation</td>
            <td><?php echo $resulation ?></td>
        </tr>
